describe('Arithmetic', function () {
    ...
    describe('Square Root', function () {
        ...
        it('returns the square root of a positive floating point number', function (done) {
            request.get('/arithmetic?operation=sqrt&operand1=4.2&operand2=0')
                .expect(200)
                .end(function (err, res) {
        ...
        it('returns null for a negative integer', function (done) {
            request.get('/arithmetic?operation=sqrt&operand1=-4&operand2=0')
                .expect(200)
                .end(function (err, res) {
        ...
        it('returns null for a negative floating point number', function (done) {
            request.get('/arithmetic?operation=sqrt&operand1=-4.2&operand2=0')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({ result: null });
